...
\hline
                              & DFT  & SNAP          & EAM            & ML-EAM         & Exp.      \\
\hline
$T_{m}$(K)                    &      & 1785          & 1520           & 1520           & 1728      \\
$c_{11}$ (GPa)                & 276  & 276 (0.0\%)   & 248 (-10.1\%)  & 274 (-0.7\%)   & 261       \\
$c_{12}$ (GPa)                & 159  & 159 (0.0\%)   & 147 (-7.5\%)   & 163 (2.5\%)    & 151       \\
$c_{44}$ (GPa)                & 132  & 132 (0.0\%)   & 125 (-5.3\%)   & 131 (-0.8\%)   & 132       \\
...
$E_{v}$ (eV)                  & 1.46 & 1.68 (15.1\%) & 1.68 (15.1\%)  & 1.71 (17.1\%)  & 1.54–1.80 \\
$E_{m}$ (eV)                  & 1.12 & 1.07 (-4.5\%) & 0.90 (-19.6\%) & 0.87 (-22.3\%) & 1.01–1.48 \\
$E_{a} = E_{v} + E_{m} $ (eV) & 2.58 & 2.75 (6.6\%)  & 2.58 (0.0\%)   & 2.58 (0.0\%)   & 2.77–2.95 \\
\hline
\end{tabular}
...
\begin{figure}
\centering
\includegraphics[scale=0.64]{figures/r_MoMo_hist.png}
\caption{\label{fig:r_MoMo_hist} The energy-volume curves of the original EAM, 
...
However, the equilibrium spacing between two adjacent Mo atoms is 2.7 \AA. This 
may explain why ML-ADP does not outperform ML-EAM on this dataset: most 
$r^{\mathrm{Mo-Mo}}$ are beyond 2.5 \AA (Figure \ref{fig:r_MoMo_hist}). 
...
$c_{11}$ (GPa)                & 472  & 473 (0.2\%)   & 457 (-3.2\%)  & 472 (0.0\%)    & 473 (0.2\%)    & 479  \\
$c_{12}$ (GPa)                & 158  & 152 (-3.8\%)  & 168 (6.3\%)   & 158 (0.0\%)    & 160 (1.2\%)    & 165  \\
$c_{44}$ (GPa)                & 106  & 107 (0.9\%)   & 116 (9.4\%)   & 106 (0.0\%)    & 105 (-0.9\%)   & 108  \\
$B_{\mathrm{VRH}}$ (GPa)      & 263  & 259 (-1.5\%)  & 264 (0.4\%)   & 262 (-0.4\%)   & 264 (0.4\%)    & 270  \\
$G_{\mathrm{VRH}}$ (GPa)      & 124  & 126 (1.6\%)   & 127 (2.4\%)   & 125 (0.8\%)    & 124 (0.0\%)    & 125  \\
...
\caption{\label{fig:alloy_eos} $\rho(r)$, $F(\rho)$, $\phi(r)$ of the original 
...
we can start from the many-body expansion (MBE) scheme.
