...
\author[b,a]{De-Ye Lin\corref{author}}
\author[a]{Wei-Dong Chu}
\author[a,b]{Hai-Feng Song\corref{author}}

\cortext[author] {Corresponding author.
\textit{E-mail address:} lindeye0716@163.com, song\_haifeng@iapcm.ac.cn}
...
For example, for the Ni-Mo system, if we select the elastic constants of $c_11$, 
$c_22$ and $c_44$ of fcc Ni and bcc Mo, and the Rose EOS of fcc Ni and bcc Mo as 
the physical constraints, thereshould be $2 \times 2$ separate computation 
graphs (\textrm{Elastic/fcc/Ni, Elastic/bcc/Mo, Rose/fcc/Ni, Rose/bcc/Mo}) under 
